...
function toggleDashboardFullscreen(){const app=document.getElementById('app');if(!app)return;if(document.fullscreenElement){document.exitFullscreen?.();return;}document.documentElement.classList.add('dashboard-fullscreen');const req=app.requestFullscreen?.();if(req&&typeof req.catch==='function')req.catch(()=>{});}
