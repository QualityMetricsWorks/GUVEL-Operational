...
let dashboardState={tab:'General',production:[],scrap:[],downtime:[],customers:[],parts:[],shifts:[],machines:[],cycleTimes:[],filters:{period:'This Month',from:'',to:'',customer:'',part:'',shift:'',machine:''},charts:{}};
...
function renderActiveDashboard(){if(dashboardState.tab==='Production')renderProductionDashboard();else if(dashboardState.tab==='Quality')renderQualityDashboard();else renderDashboardGeneral();}
...
function renderQualityDashboard(){
  ...
  <div class="quality-top3-section"><div class="section-title"><div><div class="eyebrow">QUALITY PRIORITY</div><h2>Top 3 products with highest scrap</h2><p>Highest scrap Part Numbers in the selected scope, with their three largest defect contributors.</p></div></div><div class="quality-top3-grid">${top3a||'<div class="panel"><p>No scrap recorded in the selected scope.</p></div>'}</div></div>
